...
public class LQFBInstances extends ArrayList<LQFBInstance> {
    ...
    private void initInstances() {
        ...
        if (isEmpty()) {
             this.add(new LQFBInstance(liqoidApplication,"DE_PIRATEN_BUND",
                    "Piraten Bund",
            ...
            this.add(new LQFBInstance(liqoidApplication,"DE_TESTINSTANZ_VALID",
                    "Testinstanz (valid URL)",
                    "http://dev.liquidfeedback.org/test/api/",
                    "http://dev.liquidfeedback.org/test/",
                    "GTR8MjH6x98w6mztGB7J", "1.x"));
            this.add(new LQFBInstance(liqoidApplication,"DE_TESTINSTANZ_INVALID",
